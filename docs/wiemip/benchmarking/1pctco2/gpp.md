...
![GPP maps: ctrl (control)](../../../img/wiemip/benchmarking/1pctco2/map_gpp_ctrl.png)

### bgc (biogeochemically-coupled)

![GPP maps: bgc (biogeochemically-coupled)](../../../img/wiemip/benchmarking/1pctco2/map_gpp_bgc.png)

### cou (UKESM1-0-LL)

![GPP maps: cou (UKESM1-0-LL)](../../../img/wiemip/benchmarking/1pctco2/map_gpp_cou-ukesm.png)

### cou (IPSL-CM6A-LR)

![GPP maps: cou (IPSL-CM6A-LR)](../../../img/wiemip/benchmarking/1pctco2/map_gpp_cou-ipsl.png)

### cou (GFDL-ESM4)

![GPP maps: cou (GFDL-ESM4)](../../../img/wiemip/benchmarking/1pctco2/map_gpp_cou-gfdl.png)
