...
![Heterotrophic respiration (Rh): 1pctCO2 factorials](../../../img/wiemip/benchmarking/1pctco2/lineplot_rh.png)
...
![Heterotrophic respiration (Rh) maps: ctrl (control)](../../../img/wiemip/benchmarking/1pctco2/map_rh_ctrl.png)

### bgc (biogeochemically-coupled)

![Heterotrophic respiration (Rh) maps: bgc (biogeochemically-coupled)](../../../img/wiemip/benchmarking/1pctco2/map_rh_bgc.png)

### cou (UKESM1-0-LL)

![Heterotrophic respiration (Rh) maps: cou (UKESM1-0-LL)](../../../img/wiemip/benchmarking/1pctco2/map_rh_cou-ukesm.png)

### cou (IPSL-CM6A-LR)

Baseline only — no-fire has no IPSL-driven stage.

![Heterotrophic respiration (Rh) maps: cou (IPSL-CM6A-LR)](../../../img/wiemip/benchmarking/1pctco2/map_rh_cou-ipsl.png)

### cou (GFDL-ESM4)

Baseline only — no-fire has no GFDL-driven stage.

![Heterotrophic respiration (Rh) maps: cou (GFDL-ESM4)](../../../img/wiemip/benchmarking/1pctco2/map_rh_cou-gfdl.png)
