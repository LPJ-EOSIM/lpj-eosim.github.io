...
![Heterotrophic respiration (Rh) maps: S0 control](../../../img/wiemip/benchmarking/1pctco2/map_rh_ctrl.png)

### S1: bgc-coupled

![Heterotrophic respiration (Rh) maps: S1 bgc-coupled](../../../img/wiemip/benchmarking/1pctco2/map_rh_bgc.png)

### S2: fully coupled (UKESM1-0-LL)

![Heterotrophic respiration (Rh) maps: S2 fully coupled](../../../img/wiemip/benchmarking/1pctco2/map_rh_cou-ukesm.png)
