# Ecosystem respiration (Reco): 1pctCO2
...
![Ecosystem respiration (Reco): 1pctCO2 factorials](../../../img/wiemip/benchmarking/1pctco2/lineplot_mreco.png)
...
![Ecosystem respiration (Reco) maps: S0 control](../../../img/wiemip/benchmarking/1pctco2/map_mreco_ctrl.png)

### S1: bgc-coupled

![Ecosystem respiration (Reco) maps: S1 bgc-coupled](../../../img/wiemip/benchmarking/1pctco2/map_mreco_bgc.png)

### S2: fully coupled (UKESM1-0-LL)

![Ecosystem respiration (Reco) maps: S2 fully coupled UKESM](../../../img/wiemip/benchmarking/1pctco2/map_mreco_cou-ukesm.png)

### S2: fully coupled (IPSL-CM6A-LR)

Baseline only — no-fire has no IPSL-driven stage.

![Ecosystem respiration (Reco) maps: S2 fully coupled IPSL](../../../img/wiemip/benchmarking/1pctco2/map_mreco_cou-ipsl.png)

### S2: fully coupled (GFDL-ESM4)

Baseline only — no-fire has no GFDL-driven stage.

![Ecosystem respiration (Reco) maps: S2 fully coupled GFDL](../../../img/wiemip/benchmarking/1pctco2/map_mreco_cou-gfdl.png)
