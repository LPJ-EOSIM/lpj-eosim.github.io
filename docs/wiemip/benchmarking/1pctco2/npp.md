...
![NPP maps: S2 fully coupled UKESM](../../../img/wiemip/benchmarking/1pctco2/map_npp_cou-ukesm.png)

### S2: fully coupled (IPSL-CM6A-LR)

Baseline only — no-fire has no IPSL-driven stage.

![NPP maps: S2 fully coupled IPSL](../../../img/wiemip/benchmarking/1pctco2/map_npp_cou-ipsl.png)

### S2: fully coupled (GFDL-ESM4)

Baseline only — no-fire has no GFDL-driven stage.

![NPP maps: S2 fully coupled GFDL](../../../img/wiemip/benchmarking/1pctco2/map_npp_cou-gfdl.png)
