...
![Establishment flux maps: ctrl (control)](../../../img/wiemip/benchmarking/1pctco2/map_flux_estab_ctrl.png)

### bgc (biogeochemically-coupled)

![Establishment flux maps: bgc (biogeochemically-coupled)](../../../img/wiemip/benchmarking/1pctco2/map_flux_estab_bgc.png)

### cou (UKESM1-0-LL)

![Establishment flux maps: cou (UKESM1-0-LL)](../../../img/wiemip/benchmarking/1pctco2/map_flux_estab_cou-ukesm.png)

### cou (IPSL-CM6A-LR)

Baseline only — no-fire has no IPSL-driven stage.

![Establishment flux maps: cou (IPSL-CM6A-LR)](../../../img/wiemip/benchmarking/1pctco2/map_flux_estab_cou-ipsl.png)

### cou (GFDL-ESM4)

Baseline only — no-fire has no GFDL-driven stage.

![Establishment flux maps: cou (GFDL-ESM4)](../../../img/wiemip/benchmarking/1pctco2/map_flux_estab_cou-gfdl.png)
