...
![Soil N₂O maps: ctrl (control)](../../../img/wiemip/benchmarking/1pctco2/map_mn2o_soil_ctrl.png)

### bgc (biogeochemically-coupled)

![Soil N₂O maps: bgc (biogeochemically-coupled)](../../../img/wiemip/benchmarking/1pctco2/map_mn2o_soil_bgc.png)

### cou (UKESM1-0-LL)

![Soil N₂O maps: cou (UKESM1-0-LL)](../../../img/wiemip/benchmarking/1pctco2/map_mn2o_soil_cou-ukesm.png)

### cou (IPSL-CM6A-LR)

![Soil N₂O maps: cou (IPSL-CM6A-LR)](../../../img/wiemip/benchmarking/1pctco2/map_mn2o_soil_cou-ipsl.png)

### cou (GFDL-ESM4)

![Soil N₂O maps: cou (GFDL-ESM4)](../../../img/wiemip/benchmarking/1pctco2/map_mn2o_soil_cou-gfdl.png)
