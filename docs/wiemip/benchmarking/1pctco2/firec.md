...
![Fire carbon emission: 1pctCO2 factorials](../../../img/wiemip/benchmarking/1pctco2/lineplot_firec.png)
...
![Fire carbon emission maps: S0 control](../../../img/wiemip/benchmarking/1pctco2/map_firec_ctrl.png)

### S1: bgc-coupled

![Fire carbon emission maps: S1 bgc-coupled](../../../img/wiemip/benchmarking/1pctco2/map_firec_bgc.png)

### S2: fully coupled (UKESM1-0-LL)

![Fire carbon emission maps: S2 fully coupled UKESM](../../../img/wiemip/benchmarking/1pctco2/map_firec_cou-ukesm.png)

### S2: fully coupled (IPSL-CM6A-LR)

Baseline only — no-fire has no IPSL-driven stage.

![Fire carbon emission maps: S2 fully coupled IPSL](../../../img/wiemip/benchmarking/1pctco2/map_firec_cou-ipsl.png)

### S2: fully coupled (GFDL-ESM4)

Baseline only — no-fire has no GFDL-driven stage.

![Fire carbon emission maps: S2 fully coupled GFDL](../../../img/wiemip/benchmarking/1pctco2/map_firec_cou-gfdl.png)
