...
![Fire carbon emission maps: ctrl (control)](../../../img/wiemip/benchmarking/1pctco2/map_firec_ctrl.png)

### bgc (biogeochemically-coupled)

![Fire carbon emission maps: bgc (biogeochemically-coupled)](../../../img/wiemip/benchmarking/1pctco2/map_firec_bgc.png)

### cou (UKESM1-0-LL)

![Fire carbon emission maps: cou (UKESM1-0-LL)](../../../img/wiemip/benchmarking/1pctco2/map_firec_cou-ukesm.png)

### cou (IPSL-CM6A-LR)

![Fire carbon emission maps: cou (IPSL-CM6A-LR)](../../../img/wiemip/benchmarking/1pctco2/map_firec_cou-ipsl.png)

### cou (GFDL-ESM4)

![Fire carbon emission maps: cou (GFDL-ESM4)](../../../img/wiemip/benchmarking/1pctco2/map_firec_cou-gfdl.png)
