...
![Vegetation carbon: 1pctCO2 factorials](../../../img/wiemip/benchmarking/1pctco2/lineplot_vegc.png)
...
![Vegetation carbon maps: S0 control](../../../img/wiemip/benchmarking/1pctco2/map_vegc_ctrl.png)

### S1: bgc-coupled

![Vegetation carbon maps: S1 bgc-coupled](../../../img/wiemip/benchmarking/1pctco2/map_vegc_bgc.png)

### S2: fully coupled (UKESM1-0-LL)

![Vegetation carbon maps: S2 fully coupled UKESM](../../../img/wiemip/benchmarking/1pctco2/map_vegc_cou-ukesm.png)

### S2: fully coupled (IPSL-CM6A-LR)

Baseline only — no-fire has no IPSL-driven stage.

![Vegetation carbon maps: S2 fully coupled IPSL](../../../img/wiemip/benchmarking/1pctco2/map_vegc_cou-ipsl.png)

### S2: fully coupled (GFDL-ESM4)

Baseline only — no-fire has no GFDL-driven stage.

![Vegetation carbon maps: S2 fully coupled GFDL](../../../img/wiemip/benchmarking/1pctco2/map_vegc_cou-gfdl.png)
