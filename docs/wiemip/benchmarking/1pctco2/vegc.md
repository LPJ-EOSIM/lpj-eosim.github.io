...
![Vegetation carbon maps: ctrl (control)](../../../img/wiemip/benchmarking/1pctco2/map_vegc_ctrl.png)

### bgc (biogeochemically-coupled)

![Vegetation carbon maps: bgc (biogeochemically-coupled)](../../../img/wiemip/benchmarking/1pctco2/map_vegc_bgc.png)

### cou (UKESM1-0-LL)

![Vegetation carbon maps: cou (UKESM1-0-LL)](../../../img/wiemip/benchmarking/1pctco2/map_vegc_cou-ukesm.png)

### cou (IPSL-CM6A-LR)

![Vegetation carbon maps: cou (IPSL-CM6A-LR)](../../../img/wiemip/benchmarking/1pctco2/map_vegc_cou-ipsl.png)

### cou (GFDL-ESM4)

![Vegetation carbon maps: cou (GFDL-ESM4)](../../../img/wiemip/benchmarking/1pctco2/map_vegc_cou-gfdl.png)
