...
![Autotrophic respiration (Ra): 1pctCO2 factorials](../../../img/wiemip/benchmarking/1pctco2/lineplot_mra.png)
...
![Autotrophic respiration (Ra) maps: ctrl (control)](../../../img/wiemip/benchmarking/1pctco2/map_mra_ctrl.png)

### bgc (biogeochemically-coupled)

![Autotrophic respiration (Ra) maps: bgc (biogeochemically-coupled)](../../../img/wiemip/benchmarking/1pctco2/map_mra_bgc.png)

### cou (UKESM1-0-LL)

![Autotrophic respiration (Ra) maps: cou (UKESM1-0-LL)](../../../img/wiemip/benchmarking/1pctco2/map_mra_cou-ukesm.png)

### cou (IPSL-CM6A-LR)

Baseline only — no-fire has no IPSL-driven stage.

![Autotrophic respiration (Ra) maps: cou (IPSL-CM6A-LR)](../../../img/wiemip/benchmarking/1pctco2/map_mra_cou-ipsl.png)

### cou (GFDL-ESM4)

Baseline only — no-fire has no GFDL-driven stage.

![Autotrophic respiration (Ra) maps: cou (GFDL-ESM4)](../../../img/wiemip/benchmarking/1pctco2/map_mra_cou-gfdl.png)
