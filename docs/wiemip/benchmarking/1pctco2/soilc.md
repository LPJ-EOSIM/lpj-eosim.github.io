...
![Soil carbon: 1pctCO2 factorials](../../../img/wiemip/benchmarking/1pctco2/lineplot_soilc.png)
...
![Soil carbon maps: S0 control](../../../img/wiemip/benchmarking/1pctco2/map_soilc_ctrl.png)

### S1: bgc-coupled

![Soil carbon maps: S1 bgc-coupled](../../../img/wiemip/benchmarking/1pctco2/map_soilc_bgc.png)

### S2: fully coupled (UKESM1-0-LL)

![Soil carbon maps: S2 fully coupled UKESM](../../../img/wiemip/benchmarking/1pctco2/map_soilc_cou-ukesm.png)

### S2: fully coupled (IPSL-CM6A-LR)

Baseline only — no-fire has no IPSL-driven stage.

![Soil carbon maps: S2 fully coupled IPSL](../../../img/wiemip/benchmarking/1pctco2/map_soilc_cou-ipsl.png)

### S2: fully coupled (GFDL-ESM4)

Baseline only — no-fire has no GFDL-driven stage.

![Soil carbon maps: S2 fully coupled GFDL](../../../img/wiemip/benchmarking/1pctco2/map_soilc_cou-gfdl.png)
