...
![Soil carbon maps: ctrl (control)](../../../img/wiemip/benchmarking/1pctco2/map_soilc_ctrl.png)

### bgc (biogeochemically-coupled)

![Soil carbon maps: bgc (biogeochemically-coupled)](../../../img/wiemip/benchmarking/1pctco2/map_soilc_bgc.png)

### cou (UKESM1-0-LL)

![Soil carbon maps: cou (UKESM1-0-LL)](../../../img/wiemip/benchmarking/1pctco2/map_soilc_cou-ukesm.png)

### cou (IPSL-CM6A-LR)

![Soil carbon maps: cou (IPSL-CM6A-LR)](../../../img/wiemip/benchmarking/1pctco2/map_soilc_cou-ipsl.png)

### cou (GFDL-ESM4)

![Soil carbon maps: cou (GFDL-ESM4)](../../../img/wiemip/benchmarking/1pctco2/map_soilc_cou-gfdl.png)
